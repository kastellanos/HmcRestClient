...
Gigabyte_Type._InitializeFacetMap(Gigabyte_Type._CF_fractionDigits,
   Gigabyte_Type._CF_minInclusive)
...
MACAddress4_List._InitializeFacetMap(MACAddress4_List._CF_maxLength,
   MACAddress4_List._CF_minLength)
...
WWPN2_List._InitializeFacetMap(WWPN2_List._CF_maxLength,
   WWPN2_List._CF_minLength)
...
VLANID20_List._InitializeFacetMap(VLANID20_List._CF_maxLength,
   VLANID20_List._CF_minLength)
...
CommonRESTCollection_Type._Automaton = _BuildAutomaton()
...
Metadata_Type._Automaton = _BuildAutomaton_()
...
def _BuildAutomaton_2 ():
    ...
    return fac.Automaton(states, counters, True, containing_state=None)
AtomMetadata_Type._Automaton = _BuildAutomaton_2()
